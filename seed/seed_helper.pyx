...
class _PStruct:
    ...
    def __init__(self):
        ...
        self.vals_x1 = None # type: np.ndarray 
        self.vals_x2 = None # type: np.ndarray 
        self.vals_x3 = None # type: np.ndarray 
        self.vals_x4 = None # type: np.ndarray
        
        # variables used to store the keys passed by python modules in words
        # four variables represent four parts of keys
        self.keys_x1 = None # type: np.ndarray 
        self.keys_x2 = None # type: np.ndarray 
        self.keys_x3 = None # type: np.ndarray 
        self.keys_x4 = None # type: np.ndarray
        
        # current key schedule
        self.key_schedule_0 = None # type: np.ndarray
        self.key_schedule_1 = None # type: np.ndarray
    ...
    def reset(self):
        ...
        self.keys_x3 = None
        self.keys_x4 = None
        self.key_schedule_0 = None
        self.key_schedule_1 = None
